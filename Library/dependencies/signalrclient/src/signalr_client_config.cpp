...
web::http::client::http_client_config signalr_client_config::get_http_client_config() const { return m_http_client_config; }
...
const std::map<std::string, std::string>& signalr_client_config::get_http_headers() const noexcept { return m_http_headers; }

std::map<std::string, std::string>& signalr_client_config::get_http_headers() noexcept { return m_http_headers; }

void signalr_client_config::set_http_headers(const std::map<std::string, std::string>& http_headers) { m_http_headers = http_headers; }
...
const std::shared_ptr<scheduler>& signalr_client_config::get_scheduler() const noexcept { return m_scheduler; }
...
std::chrono::milliseconds signalr_client_config::get_server_timeout() const noexcept { return m_server_timeout; }
...
std::chrono::milliseconds signalr_client_config::get_keepalive_interval() const noexcept { return m_keepalive_interval; }
} // namespace signalr
